...
const Navbar: FC<NavbarProps> = ({ toggleTheme, isDarkMode }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 p-4 bg-[#f5e6e8] dark:bg-fall-900 shadow-lg">
      <div className="flex items-center justify-between relative">
        <div className="text-4xl text-indigo-500 dark:text-fall-50 tracking-wider font-extrabold">
          <h1>k.</h1>
        </div>
